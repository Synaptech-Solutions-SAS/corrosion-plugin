...
pub use excitation::ExcitationInput;
pub use profile::{ModalModeSpec, ModalProfile, ModalProfileId};
pub use resonator::{PlaceholderResonator, ResonatorCore};
...
#[cfg(test)]
pub(crate) use resonator::{ResonatorCoefficients, SecondOrderMode};

#[cfg(test)]
mod tests {
    use super::{
        offline_peak_shared_mode_limit, realtime_mode_count_estimate,
        safe_realtime_shared_mode_limit, DamageAmount, ExcitationInput, ModalModeSpec,
        ModalProfile, ModalProfileId, PlaceholderResonator, RealtimeModeCountEstimate, RustAmount,
        SizeScale, DAMAGE_VARIATION_SPECS, FAMILY_COMPARISON_SPECS, PIPE_MODAL_PROFILE_MODES,
        PLATE_MODAL_PROFILE_MODES, RUST_VARIATION_SPECS, TANK_MODAL_PROFILE_MODES,
    };
    use crate::offline::{
